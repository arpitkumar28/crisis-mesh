...
import { Activity, Bell, Boxes, LogOut, Map, Radio, AlertTriangle, Building2 } from 'lucide-react';
...
export function OperationsShell({ title, eyebrow, children }: { title: string; eyebrow: string; children: ReactNode }) {
  ...
  return <div className="operations-shell">
    <aside className="operations-sidebar">
      <a className="operations-brand" href="/dashboard"><Image src="/brand/crisismesh-icon.png" alt="CrisisMesh" width={26} height={26} /><strong>CRISIS<span>MESH</span></strong></a>
    ...
    <main className="operations-main">
      <div className="operations-alert-strip"><span>LIVE ALERT</span><b>National disaster intelligence monitoring is active</b><small>Live data · Updated now</small></div>
